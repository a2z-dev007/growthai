...
export const metadata = {
  title: 'Privacy Policy | GrowthAI',
  description: 'Privacy Policy for GrowthAI',
};
  ...
  return (
    <main className="min-h-screen bg-[#0B0F19] overflow-hidden text-gray-300">
      ...
      <section className="pt-32 pb-20 px-6 max-w-4xl mx-auto min-h-[80vh]">
        <h1 className="text-4xl md:text-5xl font-sora font-bold text-white mb-8">Privacy Policy</h1>
        <div className="prose prose-invert max-w-none prose-p:leading-relaxed prose-headings:font-sora prose-headings:text-white">
          ...
          <p className="mb-4">
            Welcome to GrowthAI. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
          </p>

          <h2 className="text-2xl font-bold mt-10 mb-4">2. The Data We Collect About You</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">3. How We Use Your Personal Data</h2>
          <p className="mb-4">
